module DesignToken.Tokens.System exposing (sd)
...
color =
    ...
    , component =
        ...
        , scrim =
            { type_ = "color"
            , value = "{sd.reference.color.scale.transparency.20}"
    ...
    , interaction =
        ...
        , hoveredVariant =
            { type_ = "color"
            , value = "{sd.reference.color.scale.transparency.5}"
            , extensions = { scopes = [ "FRAME_FILL", "SHAPE_FILL", "STROKE_COLOR" ] }
            }
        , hoveredOnPrimary =
            { type_ = "color"
            , value = "{sd.reference.color.scale.transparency.60}"
